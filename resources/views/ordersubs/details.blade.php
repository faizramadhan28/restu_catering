  ...
  <div class="container mx-auto p-8 bg-white dark:bg-gray-800 shadow-lg">
    ...
    <div class="flex justify-between">
      <div class="flex items-center">
        <a href="{{route('subs.order')}}" class="text-gray-700 dark:text-gray-300 mr-4 font-medium focus:outline-none bg-transparent">
    ...
    <div class="flex flex-col lg:flex-row mt-8">
      ...
      <div class="mx-auto sm:px-6 lg:px-8 container text-center">
                    ...
                    <div class="flex items-center justify-between">
                      <div class="flex items-start">
                        ...
                        <div class="flex flex-col ml-3">
                          ...
                          <form action="{{route('subs.order.destroy', $id)}}" method="post">
                            @method('DELETE')
                            @csrf
        ...
        <form action="{{route('subs.checkout.put', $id)}}" method="post" enctype="multipart/form-data">
          @method('PATCH')
          @csrf
