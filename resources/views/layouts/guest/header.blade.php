            ...
            <div class="flex items-center justify-end w-full">
                ...
                <div class="flex justify-between">
                    <a href="{{ route('langganan') }}"
                        class="ml-7 text-gray-200 dark:text-white md:text-center text-sm font-semibold cursor-pointer flex items-center">
                        Langganan
                    </a>
                    <button @click="cartOpen = !cartOpen" class="text-gray-200 dark:text-white focus:outline-none mx-5">
