                    ...
                    <table class="shadow-xl" id="datatable">
                        ...
                        <tbody class="bg-gray-100 dark:bg-gray-800">
                            ...
                            <tr class="bg-white dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 text-wrap">
                                            <div class="text-sm text-gray-900 dark:text-gray-300">{{ $item->menu }}</div>
                                        </td>
                                <td class="px-6 py-4 text-wrap">
                                            <div class="text-sm text-gray-900 dark:text-gray-300">{{ $item->desc }}</div>
                                        </td>
                                <td class="px-6 py-4 text-wrap">
                                            <div class="text-sm text-gray-900 dark:text-gray-300">{{ $item->durasi }}</div>
                                        </td>
                                <td class="px-6 py-4 text-wrap">
                                        ...
                                        <td class="px-6 py-4 text-wrap">
                                            <x-dropdown align="right" width="48">
                                                ...
                                                <x-slot name="content">
                                                    ...
                                                    <form method="POST" action="{{ route('langganan.destroy', $item->id) }}">
                                                        @method('DELETE')
                                                        @csrf
