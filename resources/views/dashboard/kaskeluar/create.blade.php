                  ...
                  <div class="flex justify-between">
                    <div class="w-5/12 mx-5">
                      ...
                      <div class="mb-10 pr-10">
                        <x-forms.upload-image :identifier="'foto'" type="file"/>                    
                      </div>
                    </div>
                    <div class="w-7/12 mx-5">
                      <div class="mb-10">
                        <x-forms.label for="menu" :value="__('Nama Transaksi')" />
                        <x-forms.input id="menu" class="block mt-1 w-full text-gray-900" type="text" name="nama_transaksi" :value="old('nama_transaksi')" required autofocus />
                      </div>

                      <div class="mb-10">
                        <x-forms.label for="menu" :value="__('Tanggal Transaksi')" />
                        <x-forms.input id="menu" class="block mt-1 w-full text-gray-900" type="date" name="tgl_transaksi" :value="old('tgl_transaksi')" required autofocus />
                      </div>
  
                      <div class="mb-10">
                        <x-forms.label for="harga" :value="__('Uang Keluar')" />
                        <x-forms.input id="harga" class="block mt-1 w-full text-gray-900" type="number" name="uang_keluar" :value="old('uang_keluar')" required />
                      </div>
