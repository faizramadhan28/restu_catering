...
class HomeLanggananController extends Controller
{
    /**
    ...
    public function showOrder()
    {
        ...
        foreach (OrderLangganan::where('user_id', Auth::id())->get() as $order) {
